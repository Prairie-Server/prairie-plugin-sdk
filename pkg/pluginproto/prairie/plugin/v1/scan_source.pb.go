...
// 	protoc        (unknown)
// source: prairie/plugin/v1/scan_source.proto
...
func (ScanSourceChangeScope) Descriptor() protoreflect.EnumDescriptor {
	return file_prairie_plugin_v1_scan_source_proto_enumTypes[0].Descriptor()
}

func (ScanSourceChangeScope) Type() protoreflect.EnumType {
	return &file_prairie_plugin_v1_scan_source_proto_enumTypes[0]
}
...
func (ScanSourceChangeScope) EnumDescriptor() ([]byte, []int) {
	return file_prairie_plugin_v1_scan_source_proto_rawDescGZIP(), []int{0}
}
...
func (x *PollChangesRequest) Reset() {
	*x = PollChangesRequest{}
	mi := &file_prairie_plugin_v1_scan_source_proto_msgTypes[0]
...
func (x *ResolvedConnection) Reset() {
	*x = ResolvedConnection{}
	mi := &file_prairie_plugin_v1_scan_source_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ResolvedConnection) Descriptor() ([]byte, []int) {
	return file_prairie_plugin_v1_scan_source_proto_rawDescGZIP(), []int{1}
}
...
func (x *PollChangesResponse) Reset() {
	*x = PollChangesResponse{}
	mi := &file_prairie_plugin_v1_scan_source_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PollChangesResponse) Descriptor() ([]byte, []int) {
	return file_prairie_plugin_v1_scan_source_proto_rawDescGZIP(), []int{2}
}
...
type ScanSourceChange struct {
	...
	Scope         ScanSourceChangeScope `protobuf:"varint,2,opt,name=scope,proto3,enum=prairie.plugin.v1.ScanSourceChangeScope" json:"scope,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ScanSourceChange) Reset() {
	*x = ScanSourceChange{}
	mi := &file_prairie_plugin_v1_scan_source_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ScanSourceChange) Descriptor() ([]byte, []int) {
	return file_prairie_plugin_v1_scan_source_proto_rawDescGZIP(), []int{3}
}
...
var File_prairie_plugin_v1_scan_source_proto protoreflect.FileDescriptor

const file_prairie_plugin_v1_scan_source_proto_rawDesc = "" +
	"\n" +
	"#prairie/plugin/v1/scan_source.proto\x12\x11prairie.plugin.v1\"\xb7\x02\n" +
	"\x12PollChangesRequest\x12#\n" +
	"\rcapability_id\x18\x01 \x01(\tR\fcapabilityId\x12\x16\n" +
	"\x06marker\x18\x02 \x01(\tR\x06marker\x12E\n" +
	"\n" +
	"connection\x18\x03 \x01(\v2%.prairie.plugin.v1.ResolvedConnectionR\n" +
	"connection\x12\\\n" +
	"\rsource_config\x18\x04 \x03(\v27.prairie.plugin.v1.PollChangesRequest.SourceConfigEntryR\fsourceConfig\x1a?\n" +
	...
	"nextMarker\x12=\n" +
	"\achanges\x18\x03 \x03(\v2#.prairie.plugin.v1.ScanSourceChangeR\achanges\"s\n" +
	"\x10ScanSourceChange\x12\x1f\n" +
	"\vsource_path\x18\x01 \x01(\tR\n" +
	"sourcePath\x12>\n" +
	"\x05scope\x18\x02 \x01(\x0e2(.prairie.plugin.v1.ScanSourceChangeScopeR\x05scope*\xad\x01\n" +
	...
	" SCAN_SOURCE_CHANGE_SCOPE_SUBTREE\x10\x032j\n" +
	"\n" +
	"ScanSource\x12\\\n" +
	"\vPollChanges\x12%.prairie.plugin.v1.PollChangesRequest\x1a&.prairie.plugin.v1.PollChangesResponseBYZWgithub.com/prairie-server/prairie-plugin-sdk/pkg/pluginproto/prairie/plugin/v1;pluginv1b\x06proto3"

var (
	file_prairie_plugin_v1_scan_source_proto_rawDescOnce sync.Once
	file_prairie_plugin_v1_scan_source_proto_rawDescData []byte
)

func file_prairie_plugin_v1_scan_source_proto_rawDescGZIP() []byte {
	file_prairie_plugin_v1_scan_source_proto_rawDescOnce.Do(func() {
		file_prairie_plugin_v1_scan_source_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_prairie_plugin_v1_scan_source_proto_rawDesc), len(file_prairie_plugin_v1_scan_source_proto_rawDesc)))
	})
	return file_prairie_plugin_v1_scan_source_proto_rawDescData
}

var file_prairie_plugin_v1_scan_source_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_prairie_plugin_v1_scan_source_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_prairie_plugin_v1_scan_source_proto_goTypes = []any{
	(ScanSourceChangeScope)(0),  // 0: prairie.plugin.v1.ScanSourceChangeScope
	(*PollChangesRequest)(nil),  // 1: prairie.plugin.v1.PollChangesRequest
	(*ResolvedConnection)(nil),  // 2: prairie.plugin.v1.ResolvedConnection
	(*PollChangesResponse)(nil), // 3: prairie.plugin.v1.PollChangesResponse
	(*ScanSourceChange)(nil),    // 4: prairie.plugin.v1.ScanSourceChange
	nil,                         // 5: prairie.plugin.v1.PollChangesRequest.SourceConfigEntry
}
var file_prairie_plugin_v1_scan_source_proto_depIdxs = []int32{
	2, // 0: prairie.plugin.v1.PollChangesRequest.connection:type_name -> prairie.plugin.v1.ResolvedConnection
	5, // 1: prairie.plugin.v1.PollChangesRequest.source_config:type_name -> prairie.plugin.v1.PollChangesRequest.SourceConfigEntry
	4, // 2: prairie.plugin.v1.PollChangesResponse.changes:type_name -> prairie.plugin.v1.ScanSourceChange
	0, // 3: prairie.plugin.v1.ScanSourceChange.scope:type_name -> prairie.plugin.v1.ScanSourceChangeScope
	1, // 4: prairie.plugin.v1.ScanSource.PollChanges:input_type -> prairie.plugin.v1.PollChangesRequest
	3, // 5: prairie.plugin.v1.ScanSource.PollChanges:output_type -> prairie.plugin.v1.PollChangesResponse
...
func init() { file_prairie_plugin_v1_scan_source_proto_init() }
func file_prairie_plugin_v1_scan_source_proto_init() {
	if File_prairie_plugin_v1_scan_source_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_prairie_plugin_v1_scan_source_proto_rawDesc), len(file_prairie_plugin_v1_scan_source_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_prairie_plugin_v1_scan_source_proto_goTypes,
		DependencyIndexes: file_prairie_plugin_v1_scan_source_proto_depIdxs,
		EnumInfos:         file_prairie_plugin_v1_scan_source_proto_enumTypes,
		MessageInfos:      file_prairie_plugin_v1_scan_source_proto_msgTypes,
	}.Build()
	File_prairie_plugin_v1_scan_source_proto = out.File
	file_prairie_plugin_v1_scan_source_proto_goTypes = nil
	file_prairie_plugin_v1_scan_source_proto_depIdxs = nil
}
